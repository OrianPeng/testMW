...
const ultimateTranslations = {
  ...
  'Voice Input已开启': 'Voice Input enabled',
  'Voice Input已Close': 'Voice Input disabled',
  '阻止自动上传': 'Prevent automatic upload',
...
// 翻译所有文件
console.log('🚀 Starting ultimate final cleanup translation...');
filesToTranslate.forEach(translateFile);
console.log('✨ Ultimate final cleanup translation finished!');

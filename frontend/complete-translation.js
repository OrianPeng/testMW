...
const translations = {
  ...
  '数据表格': 'Data Table',
  '详情抽屉': 'Detail Drawer',
  '创建/Edit模态框': 'Create/Edit Modal',
  '分page配置': 'Pagination Config',
  '模拟API调用': 'Mock API call',
  '查询Failed': 'Query failed',
  'Export功能开发Medium...': 'Export feature in development...',
  '审批功能开发Medium...': 'Approval feature in development...',
  'Delete功能开发Medium...': 'Delete feature in development...',
  '更新成功': 'Update successful',
  '创建成功': 'Create successful',
  '更新Failed': 'Update failed',
  '创建Failed': 'Create failed',
  '信息完整': 'Information complete',
  '信息不完整': 'Information incomplete',
  'page面头部样式': 'Page header styles',
  '查询卡片样式': 'Search card styles',
  '统计卡片样式': 'Statistics card styles',
  '表格卡片样式': 'Table card styles',
  'Status标签样式': 'Status tag styles',
  'Actions按钮样式': 'Action button styles',
  '响应式设计': 'Responsive design',
  
  // 表单字段和选项
  '标准采购申请': 'Standard Purchase Request',
  'Urgent采购申请': 'Urgent Purchase Request',
  'Please enterPlant代码': 'Please enter plant code',
  'Please enterMaterial编号': 'Please enter material number',
  '如：EA, KG': 'e.g.: EA, KG',
  'Please enterSupplier代码': 'Please enter supplier code',
  'Material描述': 'Material Description',
  'Please enterMaterial描述': 'Please enter material description',
  'Material组': 'Material Group',
  'Please enterMaterial组': 'Please enter material group',
  '单位': 'Unit',
  '普通': 'Normal',
  '人民币': 'Chinese Yuan',
  '美元': 'US Dollar',
  '欧元': 'Euro',
  'Please enterComments信息': 'Please enter comments',
  'Please enterPR Number': 'Please enter PR number',
  'Please selectDocument Type': 'Please select document type',
  'Please enterPlant代码': 'Please enter plant code',
  'Please enterQuantity': 'Please enter quantity',
  'Please enterUnit Price': 'Please enter unit price',
  'Please enterMaterial编号': 'Please enter material number',
  'Please selectDelivery Date': 'Please select delivery date',
  'Please enterSupplier代码': 'Please enter supplier code',
  'Please enterMaterial描述': 'Please enter material description',
  'Please enterMaterial组': 'Please enter material group',
  'Please enter单位': 'Please enter unit',
  'Please enter创建人': 'Please enter requester',
  'Please enterPurchase Organization': 'Please enter purchase organization',
  '创建人': 'Requester',
  '共 ${total} 条记录': 'Total ${total} records',
  'Urgent设备采购': 'Urgent Equipment Procurement',
  '审批': 'Approve',
  '无': 'None',
...
vueFiles.forEach(translateFile);

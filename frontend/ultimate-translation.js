...
const ultimateTranslations = {
  // 注释和标签
  'page面头部': 'Page Header',
  '关键指标卡片': 'Key Metrics Cards',
  '图表区域': 'Charts Area',
  'Data Table区域': 'Data Table Area',
  '图表引用': 'Chart references',
  '关键指标': 'Key metrics',
  'Recent PR数据': 'Recent PR data',
  'Recent PO数据': 'Recent PO data',
  'Recent PR表格列': 'Recent PR table columns',
  'Recent PO表格列': 'Recent PO table columns',
  '初始化图表': 'Initialize charts',
  'PR Creation Trend图': 'PR Creation Trend chart',
  'PO Status Distribution饼图': 'PO Status Distribution pie chart',
  'Supplier采购Amount排行': 'Supplier Procurement Amount Ranking',
  'Department采购统计': 'Department Procurement Statistics',
  'Department采购': 'Department Procurement',
  '采购Amount': 'Procurement Amount',
  'Amount(万元)': 'Amount (10K)',
  'PR创建Count': 'PR Creation Count',
  '数据已Refresh': 'Data refreshed',
  'Refresh失败': 'Refresh failed',
...
function translateFile(filePath) {
  try {
    ...
    // 执行翻译
    Object.keys(ultimateTranslations).forEach(chinese => {
      const english = ultimateTranslations[chinese];
...
// 翻译所有文件
console.log('🚀 Starting ultimate translation...');
filesToTranslate.forEach(translateFile);
console.log('✨ Ultimate translation finished!');

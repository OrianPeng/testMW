...
const finalTranslations = {
  ...
  'Quick Actions按钮': 'Quick Actions Buttons',
  '消息列表': 'Message List',
  '加载Status': 'Loading Status',
  '输入区域': 'Input Area',
  '滚动到底部': 'Scroll to bottom',
  'Send消息到后端': 'Send message to backend',
  'Send消息失败': 'Send message failed',
  'Send消息失败，Please try again later': 'Send message failed, please try again later',
  'Mock API call，实际应该调用Dify API': 'Mock API call, should actually call Dify API',
  '根据消息内容返回不同的响应': 'Return different responses based on message content',
  '简单的Markdown渲染': 'Simple Markdown rendering',
  '处理文items上传': 'Handle file upload',
  '初始化聊天': 'Initialize chat',
  
  // 用户界面文本
  '欢迎使用AI Assistant': 'Welcome to AI Assistant',
  '我可以帮助您：': 'I can help you:',
  '创建采购请求（PR）': 'Create Purchase Request (PR)',
  'SearchPR和POStatus': 'Search PR and PO Status',
  'View Process Bottlenecks和Responsible': 'View Process Bottlenecks and Responsible',
  'Send PO to Supplier': 'Send PO to Supplier',
  'Please select上方的Quick Actions或直接输入您的问题。': 'Please select the Quick Actions above or directly enter your question.',
  '正在思考Medium...': 'Thinking...',
  'Close语音': 'Close Voice',
  '语音输入': 'Voice Input',
  '请帮我创建一个采购请求，我需要填写以下信息：': 'Please help me create a purchase request, I need to fill in the following information:',
  '请帮我SearchPRStatus，请提供PR Number：': 'Please help me search PR status, please provide PR number:',
  '请帮我Query PO Status，请提供PO Number：': 'Please help me query PO status, please provide PO number:',
  '流程卡点Search': 'Process Bottleneck Search',
  '请帮我View当前流程卡点，流程Responsible是谁？': 'Please help me view current process bottlenecks, who is the process responsible?',
  'Send消息失败': 'Send message failed',
  'Send消息失败，Please try again later': 'Send message failed, please try again later',
  'Mock API call，实际应该调用Dify API': 'Mock API call, should actually call Dify API',
  '根据消息内容返回不同的响应': 'Return different responses based on message content',
  '好的，我来帮您创建采购请求。请提供以下信息：': 'Good, I will help you create a purchase request. Please provide the following information:',
  '物料编号': 'Material Number',
  'Count': 'Quantity',
  '单价': 'Unit Price',
  'Supplier代码': 'Supplier Code',
  '交货Date': 'Delivery Date',
  '您可以直接上传Excel文items，或者逐步填写信息。': 'You can directly upload Excel files, or fill in the information step by step.',
  '流程': 'Process',
  '卡点': 'Bottleneck',
  '详情': 'Details',
  '信息': 'Information',
  'PR详情': 'PR Details',
  '物料': 'Material',
  '我收到了您的消息：': 'I received your message:',
  '我可以帮助您：': 'I can help you:',
  '创建采购请求(PR)': 'Create Purchase Request (PR)',
  'SearchPR/POStatus': 'Search PR/PO Status',
  'View Process Bottlenecks': 'View Process Bottlenecks',
  'Send PO to Supplier': 'Send PO to Supplier',
  '请告诉我您需要什么帮助？': 'Please tell me what help you need?',
  '对话已清空': 'Conversation cleared',
  '开始New Conversation': 'Start New Conversation',
  '文items': 'File',
  '文items ${file.name} 上传成功': 'File ${file.name} uploaded successfully',
  '语音输入已开启': 'Voice input enabled',
  '语音输入已Close': 'Voice input disabled',
  '初始化聊天': 'Initialize chat',
...
// 翻译所有文件
console.log('🚀 Starting final cleanup translation...');
filesToTranslate.forEach(translateFile);
console.log('✨ Final cleanup translation finished!');

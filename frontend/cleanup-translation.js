...
const remainingTranslations = {
  ...
  '方法': 'Methods',
  '生命周期': 'Lifecycle',
  'Page Header样式': 'Page header styles',
  'Statistics Cards样式': 'Statistics cards styles',
  '查询表单': 'Search form',
  '数据表格': 'Data table',
  '详情抽屉': 'Detail drawer',
  ...
  '审批功能开发中...': 'Approval feature in development...',
  '删除功能开发中...': 'Delete feature in development...',
  ...
  '紧急设备采购': 'Urgent Equipment Procurement',
  '审批': 'Approve',
  '无': 'None',
  '标准采购申请': 'Standard Purchase Request',
  '紧急采购申请': 'Urgent Purchase Request',
  '请输入工厂代码': 'Please enter plant code',
  '请输入物料编号': 'Please enter material number',
  '如：EA, KG': 'e.g.: EA, KG',
  '请输入供应商代码': 'Please enter supplier code',
  '物料描述': 'Material Description',
  '请输入物料描述': 'Please enter material description',
  '物料组': 'Material Group',
  '请输入物料组': 'Please enter material group',
  '单位': 'Unit',
  '请输入单位': 'Please enter unit',
  '请输入创建人': 'Please enter requester',
  '请输入采购组织': 'Please enter purchase organization',
  '创建人': 'Requester',
  '请输入PR编号': 'Please enter PR number',
  '请选择文档类型': 'Please select document type',
  '请输入数量': 'Please enter quantity',
  '请输入单价': 'Please enter unit price',
  '请选择交货日期': 'Please select delivery date',
...
function translateFile(filePath) {
  try {
    ...
    // 执行翻译
    Object.keys(remainingTranslations).forEach(chinese => {
      const english = remainingTranslations[chinese];
...
// 翻译所有文件
console.log('🚀 Starting cleanup translation...');
filesToTranslate.forEach(translateFile);
console.log('✨ Cleanup translation finished!');

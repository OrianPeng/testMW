<template>
  <div class="simple-test">
    ...
    <div class="test-section">
      <h2>Navigation</h2>
      <a-space>
        <a-button @click="$router.push('/chat')">Go to Chat</a-button>
        <a-button @click="$router.push('/pr-query')">Go to PR Query</a-button>
        <a-button @click="$router.push('/po-query')">Go to PO Query</a-button>
      </a-space>
    </div>
  </div>
</template>
